...
# select sample
data_final <- data_final %>% filter(year %in% c(2001:2010))
...
results$group <- "2001-2010"

# end timer
end.time <- Sys.time()

# save results
save.image("/home/sozialwiss/einhofja/Dokumente/analysis_decomp/output_2001_em.RData")
