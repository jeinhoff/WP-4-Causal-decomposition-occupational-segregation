...
# select sample
data_final <- data_final %>% filter(year %in% c(2011:2020))
...
results$group <- "2011-2020"

# end timer
end.time <- Sys.time()

# save results
save.image("/home/sozialwiss/einhofja/Dokumente/analysis_decomp/output_2011_em.RData")
